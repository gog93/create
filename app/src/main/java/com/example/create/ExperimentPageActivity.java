...
public class ExperimentPageActivity  extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        acupunctureTextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ExperimentPageActivity.this, AcupunctureActivity.class);
//                intent.putExtra("isEditMode",false);
        ...
        bioTextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ExperimentPageActivity.this,ExperimentActivity.class);
                startActivity(intent);
            }
        });
